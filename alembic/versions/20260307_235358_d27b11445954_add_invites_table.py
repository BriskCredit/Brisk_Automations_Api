...
Revision ID: d27b11445954
Revises: 82c7fd712771
Create Date: 2026-03-07 23:53:58.203336
...
revision: str = 'd27b11445954'
down_revision: Union[str, None] = '82c7fd712771'
...
def upgrade() -> None:
    ...
    sa.Column('inviter_ip', sa.String(length=45), nullable=True),
    sa.Column('inviter_user_agent', sa.Text(), nullable=True),
